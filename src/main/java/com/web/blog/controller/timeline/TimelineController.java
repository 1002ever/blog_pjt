...
public class TimelineController {
    ...
    @GetMapping("/timeline/type/{uid}/{tltype}")
    @ApiOperation(value="타입으로타임라인보기")
    public Object callTimelinebyType(@PathVariable String uid,@PathVariable int tltype) {
        List<Timeline> list = dao.findByUidAndTltype(uid, tltype);
